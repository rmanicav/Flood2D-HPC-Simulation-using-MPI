...
PREFIX="${3:-H}"
CFGFILE="${4:-${PROJECT_ROOT}/input/cfg/D003.cfg}"
HYDROFILE="${5:-${PROJECT_ROOT}/input/hyg/D003.txt}"
DESC="${6:-D003 Simulation}"
INPUT_DIR="${PROJECT_ROOT}/output/flood2d/txt"
BGFILE="${PROJECT_ROOT}/input/dem/D003.txt"
...
./rasterize --datadir="${PROJECT_ROOT}/output/${OUTPUT_NAME}" --nrows=7183 --ncols=9478 --bgcolors=128 --fgcolors=128 --bgdata="${BGFILE}"
