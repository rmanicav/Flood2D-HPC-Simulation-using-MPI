...
PREFIX="${3:-H}"
CFGFILE="${4:-${PROJECT_ROOT}/input/cfg/D001.cfg}"
HYDROFILE="${5:-${PROJECT_ROOT}/input/hyg/D001.txt}"
DESC="${6:-D001 Simulation}"
...
./rasterize --datadir="${PROJECT_ROOT}/output/${OUTPUT_NAME}" --nrows=2659 --ncols=1825 --bgcolors=128 --fgcolors=128 --bgdata="${BGFILE}"
