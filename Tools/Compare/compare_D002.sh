...
# ./compare_D002.sh 2394 3159 480 ../../output/flood2d-output-pkg-1/txt ../../output/flood2d-output-pkg-2/txt ../../output/flood2d-compare
...
./compare --datadir="${DIR_C}/" --nrows=2394 --ncols=3159 --bgcolors=128 --fgcolors=128 --bgdata="${BGFILE}"
